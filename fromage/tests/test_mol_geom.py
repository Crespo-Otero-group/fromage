...
def test_calc_plane_coeffs(hc1_mol):
    ...
    expected = np.array(
        [-2.91885658e-01, 7.42637123e-01, -6.02737809e-01, 1.78257478e-07]
    )
...
def test_calc_axes(rectangle_mol):
    ...
    expected_princ = np.array([0.999931, 0.011769, 0.0])
    expected_sec = np.array([0.011769, -0.999931, 0.0])
    expected_perp = np.array([0.0, 0.0, -1.0])
