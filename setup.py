...
setup(name='fromage',
      ...
      authors=' Miguel Rivera, Michael Ingham, Federico J. Hernandez, Rachel Crespo-Otero',
      author_email='federico.hernandez@bristol.ac.uk - r.crespo-otero@ucl.ac.uk',
      license='MIT',
      ...
      scripts=['fromage/scripts/fro_assign_charges.py',
               ...
               'fromage/scripts/fro_organise_cluster.py',
